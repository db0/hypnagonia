...
# Locations
# Inside of an empty {rainbow|insect|broccoli|potato|obsidian|gem|forest|sea|electronics|matrix|science|fantasy|cyberpunk|dieselpunk|mushroom|paper|bone|clock|cards|flower|moss|grimdark|bubble|balloon|smoke|mist|towers|brick|marble|fire|ice|snow|crystal|salt|psychological|metal|iron|air|bread|color|disease|hair|straw|brass|bronze|stress|anxiety|bean|glass|wing|toy|plastic|oil|shit|piss|laughter|sadness|dread|despair|drama|teeth|eye|vampire|nuclear|atomic|fungi|quicksilver|volcano|banana|biohazard|bacteria|coin|desert|candy|lego|toy|blood|uranium|virus|carbon|fungi|mercury|jade|silicon|carton|despair|happiness|anger|lust|sloth|pride|spiderweb|plasma|black hole|wood|leather|fabric|cotton|silk|velvet|rubber|concrete|stone|granite|limestone|chalk|coal|diamond|rust|dust|sand|clay|mud|water|steam|lightning|thunder|storm|cloud|rain|hail|fog|sleet|wind|tornado|hurricane|earthquake|magma|lava|ash|ember|spark|flame|shadow|light|darkness|dawn|dusk|neon|laser|hologram|static|pixel|binary|digital|analog|mechanical|gears|cog|spring|wire|circuit|battery|magnet|radiation|isotope|chemical|acid|alkaline|poison|venom|toxin|spore|pollen|seed|root|stem|leaf|petal|thorn|vine|branch|bark|sap|nectar|honey|wax|feather|scale|fur|claw|fang|beak|horn|antler|shell|pearl|coral|amber|ivory|ink|paint|charcoal|crayon|marker|pencil|yarn|thread|rope|chain|needle|hook|blade|edge|spike|bullet|arrow|web|knot|foam|jelly|syrup|caramel|chocolate|sugar|salt|pepper|spice|herb|fruit|vegetable|grain|nut|berry|coffee|tea|juice|liquor|spirit|whiskey|wine|beer|soap|perfume|powder|cream|gel|plasma|atom|electron|neutron|proton|quantum|gravity|vacuum|void|aether|dream|nightmare|memory|thought|idea|concept|myth|legend|fairy|goblin|dragon|phoenix|ghost|zombie|werewolf|demon|angel|spirit|soul|aura|chakra|crystal|amulet|relic|artifact|rune|sigil|glyph|symbol|code|cipher|puzzle|riddle|maze|fractal|spiral|vortex|portal|doorway|mirror|gear|pendulum|spring}-themed {laboratory|hospital|office|bedroom|firehouse|police station|factory|shop|school|library|museum|airport|courthouse|bakery|pharmacy|university|restaurant|theater|hotel|supermarket|warehouse|bank|post office|gas station|mall|office building|stadium|gym|tavern|bookstore|comic store|wizard tower|castle|army barracks|dojo|fighting ring|arena|train station|subway|cruise ship|carnival|prison|spaceship|starbase|maze|dining room|gallery|dungeon|mine|cafe|kitchen|garage|park|zoo|aquarium|planetarium|observatory|laboratory|greenhouse|nursery|orchard|farm|ranch|marina|harbor|dock|beach|lighthouse|church|temple|mosque|synagogue|chapel|cemetery|morgue|college|dormitory|cinema|concert hall|studio|salon|barbershop|market|arcade|bowling alley|pool hall|newsroom|broadcasting station|recording studio|vineyard|brewery|distillery|refinery|power plant|water treatment plant|recycling center|oil rig|control room|server room|vault|archive|attic|basement|cellar|pantry|laundry room|lobby|elevator|stairwell|rooftop|balcony|patio|courtyard|garden|locker room|sauna|bathhouse|clinic|dentist office|veterinary clinic|daycare|playground|classroom|auditorium|lecture hall|cafeteria|kitchen|storage room|closet|hallway|corridor|tunnel|tower|cottage|mansion|penthouse|hangar|motel|hostel|lodge|bathroom|living room|conference room|break room|computer lab|study|nursery|art room|music room|dance studio|science lab|chemistry lab|biology lab|physics lab|workshop|sewing room|game room|home theater|panic room|boiler room|engine room|supply room|fitting room|dressing room|examination room|operating room|recovery room|intensive care unit|emergency room|waiting room|reception area|ticket booth|gift shop|food court|restroom|powder room|broom closet|utility closet|janitor closet|changing room|shower room|steam room|meditation room|prayer room|confessional|sacristy|choir loft|crypt|morgue|autopsy room|embalming room|crematorium|interrogation room|holding cell|solitary confinement|guard room|armory|command center|radio room|security office|surveillance room|safe room|treasury|counting room|projection booth|sound booth|recording booth|editing suite|darkroom|printing press|mail room|filing room|copy room|data center|server farm|mechanical room|electrical room|furnace room|wine cellar|root cellar|cold storage|freezer|pantry|larder|kitchen pantry|coat check|foyer|entryway|vestibule|antechamber|alcove|reading nook|study carrel|cubicle|office pod|meeting pod|conversation pit}.  Impasto surrealism and dreamlike, Hypnagonia, wallpaper background, spiralling and non-euclidian {twisting|labyrinthian|dadaist|minimalist|confusing|horror|nightmarish} visuals. (ground-level shot:2.5)

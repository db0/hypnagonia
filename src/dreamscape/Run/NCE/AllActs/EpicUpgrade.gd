...
var secondary_choices := {
		...
		'gamble': '[Dance]: Choose a non-{concentration} card. {gcolor:[url={"definition": "enhance","meta_type": "definition"}]Enhance[/url] it {gamble_amount} times:} then {bcolor:[url={"definition": "scar","meta_type": "definition"}]Scar[/url] it:} {gamble_amount} times.',
		'skip': "[Skip]: {bcolor:Release a random card from your deck:}.",
	}

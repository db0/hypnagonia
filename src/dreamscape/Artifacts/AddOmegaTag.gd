...
func _on_artifact_added() -> void:
	...
	selection_deck.update_header("Choose card which should always start at the bottom of the deck."\
...
func _on_card_selected(operation_details: Dictionary) -> void:
	...
	chosen_card.modify_property('Tags', Terms.GENERIC_TAGS.omega.name)
